...
def get_indicator_anomalies(
    ...
    canonical_indicator = require_canonical_indicator(indicator_code)
    if not canonical_indicator.supports_anomaly:
        return []
    ...
    if use_bigquery_data_source():
        ...
        actual_col = safe_identifier(f"{indicator_code}_actual")
        trend_col = safe_identifier(f"{indicator_code}_trend")
        residual_col = safe_identifier(f"{indicator_code}_residual")
        anomaly_score_col = safe_identifier(f"{indicator_code}_anomaly_score")
